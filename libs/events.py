...
from libs.utils import dict_2_obj
from libs.decrypt import AESCipher
...
class EmployeeEnterEvent(Event):
...
class EventManager(object):
    ...
    event_type_map = dict()
    _event_list = [MessageReceiveEvent, UrlVerificationEvent, EmployeeEnterEvent]
